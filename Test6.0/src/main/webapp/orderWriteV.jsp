...
<div class="list">
	<h2>주문 하기</h2>
	<form name="orderForm" method="get" action="orderWrite.do">
		<table>
			<tr>
				<td>
				<h3>주문 상품</h3>
			...
			<c:set var="oQuantity" value="0" />
			<c:forEach items="${cart }" var="dto" varStatus="status">
				<tr>
					<td hidden="">
					<input type="text" value="<%=session.getAttribute("uID") %>" name="uID" readonly="readonly" >
					</td>
					<td hidden="">
					<input type="text" value="${dto.cCode }" name="cCode" readonly="readonly" >
					</td>
					<td hidden="">
					<input type="text" value="${dto.pCode }" name="pCode" readonly="readonly">
					</td>
					<td align="center">
					<img class="img" src="${dto.pImg_main }" width="150px" name="pImg_main">
					</td>
					<td align="left">
					${dto.pName }
					</td>
				...
				<c:set var= "oSum" value="${oSum + dto.cSum}"/>
				<c:set var= "oQuantity" value="${oQuantity + dto.cQuantity}"/>
			</c:forEach>
		</table><br>
		<table>
			<tr>
			...
			<tr>
				...
				<td>
				<input type="number" value="${oQuantity }" name="oQuantity" readonly="readonly" hidden="">
				 ${oQuantity } 개
				</td>
			</tr>
			<tr>
				...
				<td>
				<input type="number" value="${oSum }" name="oSum" readonly="readonly" hidden="">
				${oSum } 원
				</td>
			</tr>
			<tr>
