...
public class Paymentrevise_dao {

	DataSource dataSource; // Servers-context.xml을 가져올거임

	public Paymentrevise_dao() {
	try {
		...
		public ArrayList<Paymentrevise_dto> list(){
		ArrayList<Paymentrevise_dto> dtos = new ArrayList<Paymentrevise_dto>();	
		...
		try {
			...
			Paymentrevise_dto dto = new Paymentrevise_dto(pName, pImg_main, cQuantity, cDate, pCode);
